...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  return x1 * x2 + y1 * y2 === 0 ? Math.PI : Math.PI / 2;
}
...
function getSumOfDigits(num) {
  return `${num}`.split('').reduce((previousValue, currentValue) => {
